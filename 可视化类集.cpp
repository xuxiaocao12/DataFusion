...
https://blog.csdn.net/qq_29462849/article/details/85107057
PCL计算点云的法线
...
{	
	...
	pcl::io::loadPCDFile("shang.pcd", *cloud);
	//估计法线NormalEstimationNormalEstimation
...
//-------------------------------11111、simplevis函数实现最基本的点云可视化操作-------------------------------
...
/******************可视化点云自定义颜色特征**********************************************************/
// ---------------------------------------333333、演示怎样给点云着上单独的一种颜色，可以利用该技术给指顶的点云单独着色，以区别其他的点云 --------------------------------------------
